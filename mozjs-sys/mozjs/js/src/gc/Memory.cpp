...
#if defined(SERVO_WORKER_WASM) && !defined(__wasi__)
#  define SERVO_MEMORY_WASM 1
#endif
...
#  if !defined(__wasi__) && !defined(SERVO_MEMORY_WASM)
#    include <sys/mman.h>
...
#elif defined(__wasi__) || defined(SERVO_MEMORY_WASM)
